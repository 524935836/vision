<template>
  <div class="screen-container" :style="titleStyle">
    <header class="screen-header">
      ...
      <div class="title-right">
        <img class="qiehuan" :src="titleSrc" @click="handleChangeTheme" />
...
export default {
  ...
  methods: {
    ...
    recvData(data) {
      ...
      if (!this.$refs[chartName].allData) return
    ...
    // 点击切换主体
    handleChangeTheme() {
      // this.$refs.trend.allData &&
      //   this.$refs.seller.allData &&
      //   this.$refs.map.allData &&
      //   this.$refs.rank.allData &&
      //   this.$refs.hot.allData &&
      //   this.$refs.stock.allData &&
